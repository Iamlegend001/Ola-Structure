  ...
  const features = [
    {
      ...
      description:
        "Explore our state-of-the-art manufacturing facility featuring 3000+ AI-powered robots and witness precision engineering in sustainable vehicle production.",
    ...
    },
    {
      ...
      description:
        "Visit our flagship centers to experience our electric vehicle lineup, participate in product demonstrations, and receive expert consultation.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Discover our cutting-edge manufacturing processes and experience our
            electric vehicle technology through guided tours and interactive
            demonstrations at our facilities worldwide.
          </p>
          <div className="flex items-center justify-center gap-8 text-sm text-gray-500">
            <div className="flex items-center gap-2">
              <Users className="w-4 h-4" />
              <span>
                {currentStats.visitors.toLocaleString()}+ Monthly Visitors
              </span>
            </div>
            <div className="flex items-center gap-2">
        ...
        >
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <Card className="group bg-white border border-gray-200 hover:border-blue-200 hover:shadow-xl transition-all duration-300 rounded-lg overflow-hidden">
                  ...
                  <CardContent className="p-8 pt-0">
                    ...
                    {/* Action Button */}
                    <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 group">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Experience firsthand how we're building the future of sustainable
            transportation. Schedule your visit today and see innovation in
            action.
          </p>
